...
Document.prototype.$__registerHooks = function () {
  ...
  this.pre('save', function (next) {
    ...
    // Number of subdocs must be calculated out here
    // because otherwise synchronous pre-save hooks
    // could cause early termination
    var subdocs = arrays.reduce(function(memo, arr) {
